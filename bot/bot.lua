...
if not tostring(SUDO):match('%d+') then
  ...
  config = {
   ...
   "plugins",
    ...
    master_id = SUDO, 
    token_bot = token, 
    botname = (botname or "الوسكي"), 
    sudouser = (sudouser or "@BP_BP"), 
...
function load_config( )
  ...
  if not f then
    print ("\n🔖┇ جاري انشاء الكونفك :\n🔖┇ خلي ايديك والتوكن واسم البوت ومعرفك كمطور \n🔖┇ V21 وسوف يتم  تشغيل  السورس الوسكي توكن الاصدار  ")
    create_config()
  else
    f:close()
  end
...
token_botx = "7570694757:AAElWqCLbaXQu84HihZG41Gl2D9JDJGjU8w"
master_idx = 60809019
end
