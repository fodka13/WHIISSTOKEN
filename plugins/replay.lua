...
"سويت هواي شغلات سخيفه بحياتي بس عمري مصحت على واحد وقلتله ااسكت 😑",
"مشغول ويا ضلعتي  ☺️",
"مازا تريد منه 😌🍃",
...
if is_mod(msg) then return 'ختفوووووووووو💦💦️️' else return "📌 ااسكت ما اتفل عيب 😼🙌🏿" end
elseif w== "تف" then
...
return  "لو زاحفتلك جان ماقلت زاحفه 🌝🌸"
elseif w== "حبيبتي"  then
...
---------------------------------------------
elseif w == "ااسكت" or w == "اسكت" or w=="جب" then
if is_sudo(msg) then 
return   "حاضر تاج راسي ااسكتيت 😇 "
elseif is_owner(msg) then
return   "لخاطرك راح اسكت لان مدير وع راسي  😌"
elseif is_mod(msg) then
return   "فوك مامصعدك ادمن ؟؟ انته ااسكت 😏"
else
return   "ااسكت انته لاتندفر 😏"
end
